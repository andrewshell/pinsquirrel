...
* add a root extension:package script for the store zip ([24a1eb6](https://github.com/andrewshell/pinsquirrel/commit/24a1eb6b390019e85c7a28757833e1e1c297a94d))
* **extension:** package a store-ready zip with a release manifest ([dac939b](https://github.com/andrewshell/pinsquirrel/commit/dac939b860d20baa356816815b03f9e0c3dc1611))

## [3.6.0](https://github.com/andrewshell/pinsquirrel/compare/v3.5.3...v3.6.0) (2026-09-10)
...
* **extension:** close the pin window once the pin is saved ([b456483](https://github.com/andrewshell/pinsquirrel/commit/b456483f8579b5141edd32d26f1045ed23f8415e))
...
* **extension:** declare activeTab and the pin-page shortcut ([b30a6eb](https://github.com/andrewshell/pinsquirrel/commit/b30a6eb373062b995e7a87dee3cc2e28b496849a))
...
* **extension:** pin the current page from a click on the acorn ([95f22ec](https://github.com/andrewshell/pinsquirrel/commit/95f22ec4654445c6d5d96a5fc1a2fb6f99a6b3c5))
* **extension:** pin the current page from a keyboard shortcut ([2ac934d](https://github.com/andrewshell/pinsquirrel/commit/2ac934d5ccf9788e8c148fb1de58118e9b2dd8c4))
...
* **extension:** ship the options page the manifest names ([a408e35](https://github.com/andrewshell/pinsquirrel/commit/a408e3574b37e7fa8edf974031ffad5224f72d10))
...
* **hono:** add the embed save confirmation page ([694020e](https://github.com/andrewshell/pinsquirrel/commit/694020e5fb37093cac950b07b732b3fab9e62d90))
* **hono:** carry embed through the dedup redirect ([68625e2](https://github.com/andrewshell/pinsquirrel/commit/68625e28132dcc453b064077399a061dcd67de12))
* **hono:** land an embedded create on the saved page ([0d8e930](https://github.com/andrewshell/pinsquirrel/commit/0d8e9300df6070d273783c1f7883ccca78ccbcb6))
* **hono:** land an embedded edit save on the saved page ([4e0e164](https://github.com/andrewshell/pinsquirrel/commit/4e0e164cf53e4b903ce1a23929a5e3d914e42adf))
* **hono:** raise the /mcp rate limit to four requests a second ([f64589f](https://github.com/andrewshell/pinsquirrel/commit/f64589fe1b8719e913f8e546f8aa5ffcc91ea611))
* **hono:** render the edit form in embed mode ([a6323eb](https://github.com/andrewshell/pinsquirrel/commit/a6323eb9af2585b524f689e32356ddb9a229dbfb))
* **hono:** render the pin form without chrome on embed=1 ([9ae8646](https://github.com/andrewshell/pinsquirrel/commit/9ae86465da426c6523cafacaad74cfa4537311fd))
...
* **mcp:** add merge_tags and delete_tag behind tags:write ([d78811d](https://github.com/andrewshell/pinsquirrel/commit/d78811d79fc87bb70a065092d96fd817e4873798))
* **mcp:** add the create_pin tool behind pins:write ([bf49e12](https://github.com/andrewshell/pinsquirrel/commit/bf49e12f0eea5862052957ee4a64ea00e7366a58))
* **mcp:** add the delete_pin tool behind pins:write ([e6f0d7d](https://github.com/andrewshell/pinsquirrel/commit/e6f0d7d0ac423d0224e90e942e72d36d6c834841))
* **mcp:** add the update_pin tool behind pins:write ([0d7fb1e](https://github.com/andrewshell/pinsquirrel/commit/0d7fb1e602edbce7df5b186c888be407a0781900))
* **mcp:** name the existing pin when a URL is already pinned ([4f7c8f3](https://github.com/andrewshell/pinsquirrel/commit/4f7c8f3cc5ee29101c2d50c26c44db012ca0bd3c))
...
* **services:** delete a pin over a public-only surface ([2791d9e](https://github.com/andrewshell/pinsquirrel/commit/2791d9ee26b928d3082e5f3f521c35c66fefb3b4))
...
* **services:** update a pin over a public-only surface ([5e66481](https://github.com/andrewshell/pinsquirrel/commit/5e6648196a3f52da3302f61d681644bf0f450b96))
...
* **deps:** raise the fast-uri override to 4.1.3 ([8fe38c5](https://github.com/andrewshell/pinsquirrel/commit/8fe38c5d2dcba0df9452e7ed84bd212a5c3e87bf))
* **extension:** close the pin window once per navigation ([f516a84](https://github.com/andrewshell/pinsquirrel/commit/f516a840c23225a62671888a5efe2b97c1547378))
* **extension:** forget a pin window closed without saving ([384abc5](https://github.com/andrewshell/pinsquirrel/commit/384abc547e3cfba33e25f45615dde5c473afc4b0))
...
* **hono:** keep the duplicate-URL link inside the popup ([dcde4c6](https://github.com/andrewshell/pinsquirrel/commit/dcde4c64c5bd754c0a3618fb513048f1d356b6b8))
...
* **mcp:** say destructiveHint is false on update_pin and create_pin ([78c72f3](https://github.com/andrewshell/pinsquirrel/commit/78c72f31ea41487c5608817190b7611e4f5e0b52))
* **mcp:** stop a duplicate URL naming a private pin's id ([dea43cf](https://github.com/andrewshell/pinsquirrel/commit/dea43cf48ff6c21ba26ab29c1b06ea95c5a83d88))
