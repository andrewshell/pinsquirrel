...
export class PaginationService {
  ...
  static createPaginatedResponse<T>(
    ...
    const pagination = this.calculatePagination(totalCount, options)
  ...
  parsePaginationParams(params: {
    ...
    return PaginationService.parsePaginationParams(params)
  }
  ...
  calculatePagination(
    ...
    return PaginationService.calculatePagination(totalCount, options)
  }
  ...
  createPaginatedResponse<T>(
    ...
    return PaginationService.createPaginatedResponse(items, totalCount, options)
  }
}
