            ...
            <div class="relative" x-data="{ open: false }">
              ...
              >
                <a
                  ...
                  hx-get={`/pins/partial?${buildReadFilterUrl(searchParams, 'all')}`}
                  hx-target="#pin-list"
                  hx-swap="innerHTML"
                ...
                <a
                  ...
                  hx-get={`/pins/partial?${buildReadFilterUrl(searchParams, 'unread')}`}
                  hx-target="#pin-list"
                  hx-swap="innerHTML"
                ...
                <a
                  ...
                  hx-get={`/pins/partial?${buildReadFilterUrl(searchParams, 'read')}`}
                  hx-target="#pin-list"
                  hx-swap="innerHTML"
            ...
            {noTags && (
              <div class="inline-flex items-center gap-1 bg-secondary text-secondary-foreground px-2 py-1 text-sm font-medium border-2 border-foreground">
                ...
                <a
                  ...
                  hx-get={`/pins/partial?${buildClearFilterUrl(searchParams, 'notags')}`}
                  hx-target="#pin-list"
                  hx-swap="innerHTML"
