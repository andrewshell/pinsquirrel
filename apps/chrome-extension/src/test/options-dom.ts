...
/**
 * The real `options.html`, parsed into a document a test can drive.
 *
 * Loaded from disk rather than restated as a fixture string on purpose: the
 * page's code finds its elements by id, and a fixture would let the markup and
...
const html = readFileSync(
  join(import.meta.dirname, '..', '..', 'options.html'),
  'utf8'
)

export function loadOptionsDocument(): Document {
