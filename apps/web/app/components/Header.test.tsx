...
describe('Header', () => {
  it('renders PinSquirrel brand logo', () => {
    ...
    expect(screen.getByRole('link', { name: 'PinSquirrel' })).toHaveAttribute('href', '/')
  })
  ...
  describe('when user is logged in', () => {
    ...
    it('logout form posts to /logout', () => {
      ...
      const logoutForm = screen.getByRole('button', { name: 'Logout' }).closest('form')
  ...
  describe('styling and layout', () => {
    ...
    it('applies correct navigation spacing for logged out state', () => {
      ...
      expect(nav.querySelector('div')).toHaveClass('flex', 'items-center', 'space-x-2')
    })
    ...
    it('applies correct navigation spacing for logged in state', () => {
      ...
      const nav = screen.getByRole('navigation')
      expect(nav.querySelector('div')).toHaveClass('flex', 'items-center', 'space-x-4')
    })
  })
