        ...
        <PaginationContent>
          <PaginationItem>
            {isFirstPage ? (
              <span
                className={cn(
                  'inline-flex items-center justify-center whitespace-nowrap text-base font-medium',
                  'border border-transparent rounded-md h-10 px-4 py-2',
                  'gap-1 px-2.5 sm:pl-2.5 opacity-50 cursor-not-allowed text-muted-foreground'
                )}
              >
            ...
            {isLastPage ? (
              <span
                className={cn(
                  'inline-flex items-center justify-center whitespace-nowrap text-base font-medium',
                  'border border-transparent rounded-md h-10 px-4 py-2',
                  'gap-1 px-2.5 sm:pr-2.5 opacity-50 cursor-not-allowed text-muted-foreground'
                )}
              >
